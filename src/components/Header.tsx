...
export const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex items-center justify-between bg-crypto-dark/50 backdrop-blur-lg border-b border-white/5">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <SelectTrigger className={`bg-transparent border-white/10 ${isMobile ? 'w-[60px]' : 'w-[140px]'}`}>
            {isMobile ? (
              <img 
        ...
        <Button
          ...
          className="text-crypto-text-secondary hover:text-crypto-text hover:bg-white/5"
        >
